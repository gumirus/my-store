...
var _productsList = require("/src/js/components/productsList/productsList");
...
function getMainPage() {
    ...
    const product = (0, _productsList.getProductList)();
    product.getProducts(`${(0, _config.URL)}/wp-json/wp/v1/products?count=4`);
    page.append(mainTitle, product.productsList);
    return page;
}

},{"/src/js/components/mainTitle/mainTitle":"ki5if","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3","/src/js/components/productsList/productsList":"aAtZQ","/src/js/config":"k5Hzs"}],"ki5if":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
    ...
    const getProducts = async function(URI) {
        try {
            ...
            for (const product of data){
                const productCard = (0, _productCard.getProductCard)(product);
...
},{"./productsList.css":"dMm9t","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3","/src/js/components/productCard/productCard":"9WzTu"}],"dMm9t":[function() {},{}],"9WzTu":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
// Карточка товара
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["fF58y"], null, "parcelRequire08cb")
